...
void menuBiblioteca(Livro* L, List<funcionario>* LF, List<categorias>* LC, List<estante>* LE, List<pessoa>* LP) {
	...
	do {
		...
		cout << "4 - Simular entrada de pessoa" << endl;
		cout << "5 - Simular saida de pessoa" << endl << endl;
...
/*
	...
	@param LF: lista dinamica do funcionarios
	@return: retorna true caso o usuario e senha seja correto e falso caso contrario
*/
